"""
Demo script with direct connection string for testing
This bypasses the .env file to test the Atlas connection immediately
"""
...
def main():
    """Main demo function."""
    print_section("Student Attendance Management System - Direct Connection Demo")
    
    # Replace <db_password> with your actual password
    mongo_uri = "mongodb+srv://vineethrajannagari_db_user:<db_password>@cluster0.s78cfde.mongodb.net/?appName=cluster0"
    
    print(f"\nConnection string: {mongo_uri}")
    print("NOTE: Replace <db_password> with your actual MongoDB Atlas password")
    print()
    
    # Ask for password
    import getpass
    password = getpass.getpass("Enter your MongoDB Atlas password: ")
